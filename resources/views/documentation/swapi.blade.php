...
```
http {{route('swapi.planet', ['domain' => $domain, 'id' => 1])}}
```
...
`{{route('swapi.root', ['domain' => $domain])}}`
...
```
{{ urldecode(route('swapi.people', ['domain' => $domain, 'filter' => ['name' => 'luke']])) }}
```
...
```
http {{route('swapi.root', ['domain' => $domain])}}
```
...
Content-Type: application/json
{
    "films": "{{route('swapi.films', ['domain' => $domain])}}",
    "people": "{{route('swapi.people', ['domain' => $domain])}}",
    "planets": "{{route('swapi.planets', ['domain' => $domain])}}",
    "species": "{{route('swapi.species', ['domain' => $domain])}}",
    "starships": "{{route('swapi.starships', ['domain' => $domain])}}",
    "vehicles": "{{route('swapi.vehicles', ['domain' => $domain])}}"
}
```
...
```
http {{route('swapi.person', ['domain' => $domain, 'id' => 1])}}
```
...
```
http {{route('swapi.film', ['domain' => $domain, 'id' => 1])}}
```
...
```
http {{route('swapi.starship', ['domain' => $domain, 'id' => 21])}}
```
...
```
http {{route('swapi.vehicle', ['domain' => $domain, 'id' => 14])}}
```
...
```
http {{route('swapi.speciment', ['domain' => $domain, 'id' => 3])}}
```
...
```
http {{route('swapi.transport', ['domain' => $domain, 'id' => 4])}}
```
